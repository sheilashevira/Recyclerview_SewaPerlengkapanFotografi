...
public class RentBattery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(RentBattery.this,"Rent Success !", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(RentBattery.this, ActivityBattery.class);

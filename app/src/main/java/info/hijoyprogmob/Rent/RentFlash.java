...
public class RentFlash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(RentFlash.this,"Rent Success !", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(RentFlash.this, ActivityFlash.class);

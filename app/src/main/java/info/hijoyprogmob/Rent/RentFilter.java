...
public class RentFilter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(RentFilter.this,"Rent Success !", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(RentFilter.this, ActivityFilter.class);
